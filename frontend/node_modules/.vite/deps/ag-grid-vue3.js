...
var ge = class extends VanillaFrameworkOverrides {
  ...
  frameworkComponent(e, n) {
    let s = v.searchForComponentInstance(this.parent, e, 10, true) ? e : null;
    if (!s && n && n[e]) {
      const t = n[e];
      s = v.searchForComponentInstance(this.parent, t, 10, true) ? t : null;
    }
    return s;
  }
...
var Se = defineComponent({
  ...
  setup(r, { expose: d, emit: e }) {
    ...
    const h = /* @__PURE__ */ new Set(["rowDataUpdated", "cellValueChanged", "rowValueChanged"]), m = useModel(r, "modelValue"), B = ref(false), w = ref(false), E = e;
    watch(
      m,
      (a, u) => {
        l.value && (w.value || (B.value = true, P("rowData", R(a), R(u))), w.value = false);
      },
      { deep: true }
    );
    const G = Ce(() => {
      ...
      f && !a || !f && a || h.has(u) && (B.value || I(u), B.value = false);
    }, P = (a, u, f) => {
      if (l.value) {
        let y = u.value || u;
    ...
    return onMounted(() => {
      ...
      const a = new fe(getCurrentInstance(), z()), u = {
        ...
        _combineAttributesAndGridOptions(R(n.gridOptions), n, [
          ..._GET_ALL_GRID_OPTIONS(),
      ...
      y !== void 0 && (f.rowData = R(y)), t.value = createGrid(s.value, f, u), l.value = true;
    }), onUnmounted(() => {
      var a;
      l.value && ((a = t == null ? void 0 : t.value) == null || a.destroy(), o.value = true);
    }), d({
      api: t
    }), (a, u) => (openBlock(), createElementBlock("div", he, null, 512));
  }
});
export {
  Se as AgGridVue
